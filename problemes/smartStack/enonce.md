...
## Problème:
On souhaite implémenter une structure de donnée semblable à une pile , à la différence que l'on souhaite pouvoir retirer des éléments à la base et au sommet , la SmartStack stockera uniquement des entiers relatifs , de -2 147 483 648 à 2 147 483 647
...
les instructions doivent être exécutées dans **l'ordre**.
```
PUSH 4      # ajouter 4
PUSH 0      # ajouter 0
PUSH -9      # ajouter -9
...
PRINTSTACK  # afficher le contenu de la smartStack
```
  + la première ligne indique le nombre d'instructions
